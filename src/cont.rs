            ...
            Plain(es, k) => match es {
                ...
                _ => {
                    ...
                    match e {
                        ...
                        &Instr::LocalSet(i) => {
                            self.locals[i] = vs.pop().unwrap().clone();
                            k
                        }
                        &Instr::LocalGet(i) => {
                            vs.push(self.locals[i].clone());
                            k
                        }
                        &Instr::Br(n) => {
...
mod tests {
    ...
    pub fn test() {
        ...
        let result = vm
            .run(&vec![Instr::I32Const(1), Instr::I32Const(1), Instr::I32Add])
            .last()
            .cloned();
                ...
                Instr::Block(
                    ...
                    vec![Instr::Loop(
                        ...
                        vec![
                            ...
                            Instr::I32Const(20),
                            Instr::I32Eq,
                            Instr::If(BlockType::Empty, vec![Instr::Br(2)], vec![Instr::Br(1)]),
                        ],
                    )],
                ),
                Instr::LocalGet(0),
